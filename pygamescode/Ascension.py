...
class Game:
    ...
    def on_init(self):
        ...
        self.Ascensiontitletext = displaylib.font(75, "Ascension", (0,0,0), False)
    ...
    def on_render(self):
        try:
            pygame.display.init()
            self.openingScreen._image_surf = pygame.transform.scale(self.openingScreen._image_surf, (self.windowSize[0],self.windowSize[1]))
            self._display_surf.blit(self.openingScreen._image_surf,(0,0))
            self._display_surf.blit(self.Ascensiontitletext.text_surf,(20,20))
            self._display_surf.blit(self.startleveltext.text_surf, (20,self.Ascensiontitletext.text_surf.get_height()+15))
            pygame.display.flip()
        except: 
            print(pygame.error())
